                                ...
                                <div className="absolute right-0 w-full md:max-w-screen-sm md:w-screen mt-2 origin-top-right">
                                    {
                                        open ? <><div className="px-2 pt-2 pb-4 bg-white rounded-md shadow-lg dark:bg-gray-700">
                                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                                ...
                                                <Link className="flex row items-start rounded-lg bg-transparent p-2 dark:hover:bg-blue-900 dark:focus:bg-blue-900 text-comptech-950 dark:text-gray-200 dark:focus:text-white dark:hover:text-white hover:text-gray-900 focus:text-comptech-950 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline" to={"/teams/DevOps"} >
                                                    <div className="bg-comptech-100 text-white rounded-lg p-3">
                                                        <SiAzuredevops />
                                                    </div>
                                                    <div className="ml-3">
